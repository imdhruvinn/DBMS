    ...
    return (
      ...
      <form onSubmit={this.handleSubmit} className="form-class">
        ...
        <div>
          ...
          <input id="wf" type='email' value={this.state.email} onChange={this.emailInputHandler} required/>
        </div>
        <div>
          <label id="l"> Password </label>
          <input id="wf" type='password' value={this.state.password} onChange={this.passwordInputHandler} required/>
        </div>
        <div>
          <label id="l"> Confirm Password </label>
          <input id="wf" type='password' value={this.state.confirmpassword} onChange={this.confirmInputHandler} required/>
        </div>
