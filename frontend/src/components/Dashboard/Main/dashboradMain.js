      ...
      if(this.expand === "Teacher") {
        ...
        return (
          <div>
            ...
            <br/>
            <MainCard title='Teachers' value={this.props.dashboardDetails.teacherActive} total={this.props.dashboardDetails.teacherActive + this.props.dashboardDetails.teacherBlocked}  image={TeacherImg} />
            ...
            <MainCard title='Students' value={this.props.dashboardDetails.studentActive} total={this.props.dashboardDetails.studentActive + this.props.dashboardDetails.studentBlocked} image={StudentImg} />
            <button onClick={()=>(this.handleTableExapand("Student"))}>Show</button>
            <MainCard title='Subjects' value={this.props.dashboardDetails.subjectActive} total={this.props.dashboardDetails.subjectActive + this.props.dashboardDetails.subjectBlocked} image={SubjectImg} />
            <div className={this.props.classes.inlineblock}>
